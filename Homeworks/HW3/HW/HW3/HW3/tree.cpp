...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
    ...
    if (n2 == 0)
        ...
        return 0;
    int notEqual = countIncludes(a1+1, n1-1, a2, n2);
    int equal = (a1[0] == a2[0] ? countIncludes(a1+1, n1-1, a2+1, n2-1) : 0);
...
// Upon return from the function, the array is a
...
void order(double a[], int n)
{
    ...
    order(a, firstNotGreater); order(a+firstLess, n-firstLess);
    return;
}
